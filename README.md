...
설치 후 새로고침하고 **일코 OFF** 버튼을 누릅니다. 모바일에서는 왼쪽 아래에 표시됩니다. 버튼이 가려졌다면 확장 설정의 **Quiet Notes · 일코 모드**를 펼쳐 켤 수도 있습니다. 원래 UI 테마를 선택한 상태에서 사용하세요. 이전 Quiet Notes 시험용 태번 헬퍼 스크립트는 꺼 두세요.
